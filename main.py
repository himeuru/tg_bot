...
def satellites(message):
    if message.text == 'спутники':
        bot.send_message(message.chat.id, 'спутники:\n'
                                          ...
                                          '\n'
                                          'Юпитера: 3.1 Амальтея, 3.2 Ананке, 3.3 Ганимед, 3.4 Гималия,\n'
                                          '3.5 Европа, 3.6 Ио, 3.7 Каллисто, 3.8 Карме, 3.9 Леда, 3.10 Лиситея,\n'
                                          '3.11 Пасифе, 3.11 Синопе, 3.12 Элара\n'
                                          '\n'
                                          'Сатурна: 4.1 Титан, 4.2 Япет, 4.3 Рея, 4.4 Тефия, 4.5 Диона,\n'
                                          '4.6 Энцелад, 4.7 Мимас, 4,8 Гиперион, 4.9 Феба, 4.10 Янус,\n'
                                          '4.11 Эпиметей\n'
                                          '\n'
                                          'Урана: 5.1 Титания, 5.2 Оберон, 5.3 Ариэль, 5.4 Умбриэль,\n'
                                          '5.5 Миранда, 5.6 Пак, 5.7 Джульетта, 5.8 Порция, 5.9 Крессида,\n'
                                          '5.10 Дездемона, 5.11 Розалинда, 5.12 Белинда, 5.13 Корделия,\n'
                                          '5.14 Офелия, 5.15 Бианка, 5.16 Калибан, 5.17 Сикоракса,\n'
                                          '5.18 Пердита, 5.19 Сетебос, 5.20 Стефано, 5.21 Просперо,\n'
                                          '5.22 Фердинанд, 5.23 Маб, 5.24 Купидон, 5.25 Маргарита\n'
                                          '\n'
                                          'Нептуна: 6.1 Тритон, 6.2 Нереида, 6.3 Ларисса, 6.4 Протей,\n'
                                          '6.5 Деспина, 6.6 Галатея, 6.7 Таласса, 6.8 Наяда, 6.9 Галимеда,\n'
                                          '6.10 Псамафа')
